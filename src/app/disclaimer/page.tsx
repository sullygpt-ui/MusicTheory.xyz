...
export const metadata = createMetadata({
  ...
  description: 'FTC-compliant affiliate disclosure for MusicTheory.xyz. Learn how our affiliate relationships work.',
  path: '/disclaimer',
});
...
export default function DisclaimerPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 prose-theory">
      ...
      <p>
        MusicTheory.xyz is a participant in the Signals Music Studio affiliate program. This means that <strong>we may earn a commission when you purchase a product through our affiliate links at no extra cost to you</strong>.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>The instructor has been profiled in Forbes for music education</li>
        <li>They provide comprehensive, structured learning paths</li>
        <li>They offer a 15-day money-back guarantee</li>
      </ul>

      <h2>Questions?</h2>
      <p>
        If you have any questions about our affiliate relationships or this disclaimer, please contact us at disclosure@musictheory.xyz.
      </p>
    </div>
  );
}
