...
export const metadata = createMetadata({
  ...
  description: 'MusicTheory.xyz privacy policy — how we collect, use, and protect your personal information.',
  path: '/privacy',
});
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 prose-theory">
      ...
      <p>We use Google Analytics to understand how visitors interact with our website. Google Analytics collects information such as how often users visit the site, what pages they visit, and what other sites they used prior to coming to our site. We use this information solely to improve our website.</p>
      ...
      <h2>Contact</h2>
      <p>For privacy-related inquiries, email us at privacy@musictheory.xyz.</p>
    </div>
  );
}
